...
dir = list(load = here("005_documents/plot_scripts/mzb_sensitivity_analysis.R"),
           save = here("002_working_package_02/001_community_data/002_combined/002_invertebrates/004_plots/02_sensitivity_analysis/")
)
...
for (i in seq_along(ch_plot_files)) {
        ...
        save_name = ch_plot_files[i] %>% 
                ...
                str_replace("mzb", "macroinvertebrates") %>% 
                paste0(".png")
