...
# load data  --------------------------------------------------------------
spe = readRDS("003_processed_data/009_2020-08-18diatom_species_no_rare_w_LSRT.RDS")
gen = readRDS("003_processed_data/009_2020-08-18diatom_genus_no_rare_w_LSRT.RDS")
