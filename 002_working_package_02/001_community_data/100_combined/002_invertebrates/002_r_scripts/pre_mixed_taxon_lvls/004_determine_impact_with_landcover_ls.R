...
bio <- readRDS("003b_2020-03-26_mzb_sites_close_to_ls_small_withWSO.RDS")
all_bio <- readRDS("003_2020-03-26_mzb_data_close_to_ls_small.RDS")
...
# Save to file  -----------------------------------------------------------
saveRDS(file = paste0("004b_",Sys.Date(), "_mzb_data_low_ls.RDS"),
        object = all_bio2)

saveRDS(file = paste0("004b_",Sys.Date(), "_mzb_sites_low_ls.RDS"),
        object = sites_low)
