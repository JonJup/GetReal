...
# save to file  -------------------------------------------------------------------
saveRDS(object = join_spe,  file = paste0("009_", Sys.Date(), "diatom_species_w_rare_w_LSRT.RDS"))
saveRDS(object = join_gen,  file = paste0("009_", Sys.Date(), "diatom_genus_w_rare_w_LSRT.RDS"))
