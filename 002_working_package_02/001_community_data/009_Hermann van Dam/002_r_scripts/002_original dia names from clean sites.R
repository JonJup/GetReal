...
setwd("~/01_Uni/03_GetReal/002_WP_02/001_Community Data/009_Hermann van Dam/")


# read data ---------------------------------------------------------------

data       <- readRDS("03_FinalData/01_191216_data_before_taxon_clean_dia_Ecosurv.RDS")
...
low_impact <- low_impact[data.set == "dia_Ecosurv"]
...
saveRDS(data_new,
        paste0("006_",
               Sys.Date(),
               "_data_from_low_impact_sites_HvD.RDS"
        ))
