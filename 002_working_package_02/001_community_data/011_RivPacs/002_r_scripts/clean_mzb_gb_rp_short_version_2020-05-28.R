...
saveRDS(data4, paste0("03_FinalData/05b_",Sys.Date(),"_final_taxon_join_mzb_Rivpacs_high_phyla.RDS"))
data4 = readRDS("03_FinalData/05b_2020-05-28_final_taxon_join_mzb_Rivpacs_high_phyla.RDS")
...
saveRDS(level_list, paste0("~/01_Uni/03_GetReal/002_WP_02/001_Community Data/011_RivPacs/03_FinalData/08_",Sys.Date(),"_level_list_mzb_Rivpacs.RDS"))
...
st_write(final, paste0("03_FinalData/09_",Sys.Date(),"_MZB_Rivpacs_high_phyla.gpkg"))   
saveRDS(final,  paste0("03_FinalData/09_",Sys.Date(),"_MZB_Rivpacs_high_phyla.RDS")) 
