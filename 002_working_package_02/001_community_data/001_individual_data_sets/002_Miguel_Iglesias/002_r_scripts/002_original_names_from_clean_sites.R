...
setwd("~/01_Uni/03_GetReal/002_WP_02/001_Community Data/002_Miguel_Iglesias/")


# read data ---------------------------------------------------------------

data = readRDS("03_FinalData/01_191217_data_before_taxon_clean_dia_Miguel_Iglesias.RDS")
...
low_impact <- low_impact[data.set == "dia_Miguel_Iglesias"]
...
saveRDS(data_new,
        paste0("002_",
               Sys.Date(),
               "_data_from_low_impact_sites_MI.RDS"
        ))
