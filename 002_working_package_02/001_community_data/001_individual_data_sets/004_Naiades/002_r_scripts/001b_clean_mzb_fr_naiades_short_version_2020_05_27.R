...
data2 = readRDS("03_FinalData/01_2020-05-27_data_before_taxon_clean_mzb_Naiades.RDS")
...
saveRDS(level_list, paste0("~/01_Uni/08_",Sys.Date(),"_level_list_mzb_Naiades.RDS"))
...
st_write(final, paste0("03_FinalData/09_",Sys.Date(),"_MZB_Naiades_high_phyl_x.gpkg"))   
