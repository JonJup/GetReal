### -------------------------- ### 
# --- Clean MZB Oscar Belmar --- #
# ------ Short Version --------  # 
### -------------------------- ### 

## 24.10.19
## GR WP2 
## Here I clean and harmonize the biological data from Oscar Belmar 
...
saveRDS(data4, paste0("03_FinalData/05b_",Sys.Date(),"_final_taxon_join_mzb_Oscar_Belmar_high_phyla.RDS"))
data4 <- readRDS("03_FinalData/05b_2020-05-28_final_taxon_join_mzb_Oscar_Belmar_high_phyla.RDS")
...
saveRDS(level_list, paste0("~/01_Uni/03_GetReal/002_WP_02/001_Community Data/013_Oscar Belmar/03_FinalData/08_",Sys.Date(),"_level_list_mzb_oscar_belmar.RDS"))
...
st_write(final, paste0("03_FinalData/09_",Sys.Date(),"_MZB_Oscar_Belmar_high_phyla.gpkg") )  
saveRDS (final, paste0("03_FinalData/09_",Sys.Date(),"_MZB_Oscar_Belmar_high_phyla.RDS")  ) 
