...
## 04.11.19
## GR WP2 
## Here I clean and harmonize the biological data from Christian Feld from the WISER project.
...
# 01. Setup -------------------------------------------------------------------
pacman::p_load(dplyr, here, readxl, stringr, readr, data.table, taxize, sf, lubridate, tmap, purrr)
tmap_mode("view")

setwd(here("012_Christian Feld"))

samples = read_excel("01_OriginalData/WISER_Invertebrate_taxa.xlsx") %>% 
  setDT
sites = read_excel("01_OriginalData/WISER_Metadata_Abiotics.xls") %>% setDT
...
data = left_join(samples2,
                 sites2,
                 by = "site")
  

saveRDS(data, "03_FinalData/01_191212_data_before_taxon_clean_mzb_WISER.RDS")
data = readRDS("03_FinalData/01_191212_data_before_taxon_clean_mzb_WISER.RDS")
...
saveRDS(classification.object, "03_FinalData/02_191212_classification.object_mzb_WISER.RDS")
classification.object = readRDS("03_FinalData/02_191212_classification.object_mzb_WISER.RDS")
...
saveRDS(taxontable, "03_FinalData/03_191212_initial_taxon_mzb_WISER.RDS")
taxontable = readRDS("03_FinalData/03_191212_initial_taxon_mzb_WISER.RDS")

# now enter new rows to clean_diatoms and clean_gbif_errors
taxontable[order != "NA", clean := T]
taxontable[clean == F, taxon] %>% sort

saveRDS(taxontable, "03_FinalData/04_191212_post_correction_taxontable_mzb_WISER.RDS")
taxontable = readRDS("03_FinalData/04_191212_post_correction_taxontable_mzb_WISER.RDS")
...
greb2
saveRDS(data4, "03_FinalData/05b_200514_final_taxon_join_mzb_WISER_high_phyla.RDS")
...
saveRDS(level_list, "~/01_Uni/03_GetReal/002_WP_02/001_Community Data/011_RivPacs/03_FinalData/08_2020-05-14_level_list_mzb_WISER.RDS")
...
data4[, c("site_id", "date_id") := list(
  ...
  map_int(data4$dear, ~ which(unique_dates == .x ))
)]
...
data4[,gr_sample_id := paste0("site_", site_id2, "_date_", date_id2,"_mzb_WISER")]
...
st_write(final, "03_FinalData/09_200514_MZB_mzb_WISER_High_phyla.gpkg")   
saveRDS(final, "03_FinalData/09_200514_MZB_mzb_WISER_High_phyla.RDS")   
