...
mzb_sites2$distance_to_river = numeric(nrow(mzb_sites))
...
saveRDS(object = mzb_sites2, 
        file = paste0("../../../002_comparing_typologies/003_processed_data/","001_",Sys.Date(),"_clean_mzb_with_ls_broad_type.RDS"))
