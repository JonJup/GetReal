...
#diatom_sites2 <- st_transform(diatom_sites2, crs = st_crs(gloric))
gloric %<>% st_transform(crs = 4326)
# remove far away sites ---------------------------------------------------

nn = st_nearest_feature(diatom_sites2, gloric); beepr::beep()
...
diatom_sites2 %<>% mutate(Kmeans_30 = Kmeans_30$Kmeans_30)
...
saveRDS(object = diatom_sites3, 
        file = paste0("../../../002_comparing_typologies/003_processed_data//",Sys.Date(),"_clean_dia_with_gloric_kmeans.RDS"))
