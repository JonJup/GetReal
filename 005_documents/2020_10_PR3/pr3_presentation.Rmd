...
---
#Taxa richness of assemblages
```{r plot-mzb-n-taxa, echo=F, fig.height=6,fig.width=10, fig.align="center"}
...
---
#Uniqueness scores
```{r plot-uni, echo=FALSE, fig.align="center", fig.width=10}
...
---
#PCoA of Assemblages
```{r pcoa, echo=FALSE, fig.height=7, fig.width=9,fig.align="center"}
source("r/pcoa.R")
bim  
