...
We also used non metric multidimensional scaling (NMDS) to visualize the similarity of TAs, based on Jaccard distance matrices. 

```{r pcoa, echo=FALSE, fig.height=8}
source("../r/pcoa.R")
