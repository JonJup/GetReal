...
dir_nmds = here("002_working_package_02/003_seasonality/003_results/invertebrates/004_nmds/")
dir_seas = here("002_working_package_02/003_seasonality/003_results/invertebrates/004_nmds/distance_matrices/")

# data ---------------------------------------------------------------
vg_nmds = readRDS(file.path(dir_nmds, "2020-11-10_nmds_rt4_5_iter1500_converged.RDS"))
ch_seas = readRDS(file.path(dir_seas, "season_rt4_5_all.RDS"))
