...
# Wrap the discharge per catchment script in a function 
      ...
      cat = st_read("../01_Stream_Network/01_CCM2/02_GPKG/Catchment/2019-06-05_allGRcountires_WGS84.gpkg")
      ...
      vec_prec <- lapply(X = c("test/1979_03.tif", "test/1979_04.tif",  "test/1979_05.tif"),
                         FUN = brick)
